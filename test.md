...
class Subject {
    ...
    init(name:String) {
        self.name = name  //위에 초기화가 안되도 아래 했기때문에 위 초기화는 괜찮다.
    }

    init() {
        print("초기화") //프로퍼티는 끝날때 모두 초기화가 되있어야 한다.
    }
